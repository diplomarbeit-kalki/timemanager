...
export function DeleteTransponder({ id }: { id: string }) {
    ...
    return (
        <form action={deleteTransponderWithId}>
            <button className="rounded-md border border-gray-400 dark:border-gray-500 p-2 bg-red-300 dark:bg-red-500 hover:bg-red-400 dark:hover:bg-red-600 dark:text-gray-300">
